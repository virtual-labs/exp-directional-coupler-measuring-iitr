    ...
    */
    ...
    function setStage(self) {
      ...
      */
      ...
      WMarginLT = (BW-W.clientWidth)/2;
      WMarginTP = (BH-W.clientHeight)/2;
  
      WS.left = WS.top = 0;
      WS.margin = WMarginTP + 'px 0 0 ' + WMarginLT + 'px';
      WS.zIndex = opt.zIndex;
  
      //set radius and center point value
      self.radius = WRad - KRad;
      self.center = {x:WRad+WMarginLT, y:WRad+WMarginTP};
   ...
   if(text == "Beam Voltage" )
   {
    Swal.fire({
     ...
     width:'480px',
      ...
      text:'Toggle the switch button and note down the value for V4.',     
      icon:'warning',
      });
   }
  else if(v3==0){
...
Swal.fire({
 ...
 width:'480px',
  ...
  html:'Click on <b style="color:blue">Calculate</b> button to calculate directivity and coupling factor.',     
  icon:'info',
  });
